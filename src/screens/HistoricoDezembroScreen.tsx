...
export default function HistoricoDezembroScreen() {
  ...
  return (
    <ScrollView contentContainerStyle={styles.container}>
      ...
      <View style={styles.card}>
        ...
        <Text style={styles.value}>Risco extremo - 91%</Text>
      </View>

      <View style={styles.card}>
        <Text style={styles.label}>📍 Região Sul:</Text>
        <Text style={styles.value}>Risco extremo - 87%</Text>
      </View>

      <View style={styles.card}>
        <Text style={styles.label}>📍 Região Leste:</Text>
        <Text style={styles.value}>Risco extremo - 95%</Text>
      </View>

      <View style={styles.card}>
        <Text style={styles.label}>📍 Região Oeste:</Text>
        <Text style={styles.value}>Risco extremo - 89%</Text>
      </View>
