...
export default function HistoricoMarcoScreen() {
  ...
  return (
    <ScrollView contentContainerStyle={styles.container}>
      ...
      <View style={styles.card}>
        ...
        <Text style={styles.value}>Risco alto - 58%</Text>
      </View>

      <View style={styles.card}>
        <Text style={styles.label}>📍 Região Sul:</Text>
        <Text style={styles.value}>Risco alto - 50%</Text>
      </View>

      <View style={styles.card}>
        <Text style={styles.label}>📍 Região Leste:</Text>
        <Text style={styles.value}>Risco alto - 55%</Text>
      </View>

      <View style={styles.card}>
        <Text style={styles.label}>📍 Região Oeste:</Text>
        <Text style={styles.value}>Risco alto - 60%</Text>
      </View>
