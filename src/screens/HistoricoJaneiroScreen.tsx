...
export default function HistoricoJaneiroScreen() {
  ...
  return (
    <ScrollView contentContainerStyle={styles.container}>
      ...
      <View style={styles.card}>
        ...
        <Text style={styles.value}>Risco muito alto - 84%</Text>
      </View>

      <View style={styles.card}>
        <Text style={styles.label}>📍 Região Sul:</Text>
        <Text style={styles.value}>Risco alto - 78%</Text>
      </View>

      <View style={styles.card}>
        <Text style={styles.label}>📍 Região Leste:</Text>
        <Text style={styles.value}>Risco alto - 81%</Text>
      </View>

      <View style={styles.card}>
        <Text style={styles.label}>📍 Região Oeste:</Text>
        <Text style={styles.value}>Risco considerável - 72%</Text>
      </View>
